...
## Introduction
- SFU CMPT 300: Operating Systems I, Individual Project: List Implementation via C.
- This assignment is to implement the List abstract data type. The list data structure is widely used throughout operating system programming.
